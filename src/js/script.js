...
function createInput(id, value, name, type = 'text', placeholder = '') {
  ...
  addTechBtn.addEventListener('click', function (ev) {
    ...
    newRow.append(
       techNameLabel, techNameInput, br1, expLabel, expRadio1, expLabel1, expRadio2, expLabel2, expRadio3, expLabel3, br2, removeRowBtn
    )
  ...
  form.addEventListener('submit', function (ev) {
    ...
    inputRows.forEach(function (row) {
      ...
      technologies.push({ name: techName.value, exp: techExp.value })
    })
